---
title: Calendar
description: The calendar of Gelbenhügel
tags:
---
Gelbenhügeler mark the passage of time by counting the rotation of the sun disk and the orbits of the outer worlds. Each rotation of the sun disk, which takes approximately twenty hours, is recorded as one day. The outer worlds make one orbit around the world disk every 320 days, which is recorded as a year. Within the year, they divide the days into 40 groups of eight, called weeks.

Before the Great War, the Volk standardized the names of the days of the week for ease of commerce. In any given language, the days are known as:
...
| Flower time         | Blumenzeit       |
| Spring rains        | Frühlingsregen   |
| **Summer**          | **Sommer**       |
| Asparagus time      | Spargelzeit      |
| Fruit time          | Fruchtzeit       |
| Grains seed         |                  |
| Barley season       | Gerstenerntezeit |
| Old woman's summer  | Altweibersommer  |
| **Autumn**          | **Herbst**       |
| Leaf falling time   | Laubfallzeit     |
| Heat retreats       |                  |
| White dew           |                  |
| Cold dew            |                  |
| Frost falls         |                  |
...
| Beginning of winter |                  |
| Lesser snow         |                  |
| High winter         | Hochwinter       |
| Deep winter         | Tiefwinter       |
| Greater cold        |                  |
## Holidays and Festivals

- **Wochenendfestival** is held almost every Week End in the Volkshalle in honor of the Spirit of the City. When other major festivals are held, the clergy of the Spirit of the City take a well-deserved break.
